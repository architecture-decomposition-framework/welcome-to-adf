...
| ![Interface](sw@rt/interface.drawio.png) | Interfaces are used as entities for defining clear component boundaries. Each interface is centered about a specific role that a component has. |
| ![Interface Connector](sw@rt/interface_connector.drawio.png) | Interface connectors can be used with systems or components. Left side (lollypop) provides interface, right side requires interface. |
...
| ![Interface](sw@dt/interface.drawio.png) | Interfaces are used as entities for defining clear component boundaries. Each interface is centered about a specific role that a component has. |
